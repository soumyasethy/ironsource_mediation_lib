...
/// No restriction other than basic types, validations happen on the native level
///   except for the Gender type
class IronSourceSegment {
  ...
  double? iapTotal;
  Map<String, String> customParameters = Map();

  /// @returns
  /// Successfully set a custom param: true
  /// Already has 5 custom params: false
