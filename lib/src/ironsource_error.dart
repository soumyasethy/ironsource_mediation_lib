/// wrapper class for ironSource SDK Errors
/// https://developers.ironsrc.com/ironsource-mobile/android/advanced-settings/#step-4
class IronSourceError {
  final int? errorCode;
  final String? message;

  IronSourceError({this.errorCode, this.message});
