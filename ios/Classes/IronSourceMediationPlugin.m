...
@interface IronSourceMediationPlugin() <ISRewardedVideoDelegate, ISInterstitialDelegate, ISBannerDelegate, ISOfferwallDelegate, ISImpressionDataDelegate, ISConsentViewDelegate>
...
- (void)initWithArgs:(nullable id)args result:(nonnull FlutterResult)result {
    ...
    if(adUnits != nil && adUnits.count){
        ...
        [IronSource initWithAppKey:appKey adUnits:parsedAdUnits];
    } else {
